        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Column(
                children: [
                  Text("Welcome", style: GoogleFonts.alegreya(color: Colors.white, fontSize: 34, fontWeight: FontWeight.w700)),
                  Text("Do meditation. Stay focused. Live a healthy life", style: GoogleFonts.alegreyaSans(color: Colors.white, fontSize: 20, fontWeight: FontWeight.w500), textAlign: TextAlign.center),
                  SizedBox(height: 120),
                  Container(
                    margin: EdgeInsets.only(bottom: 15),
